...
class EliteCard(Card, Combatable, Magical):
    ...
    def play(self, game_state: dict) -> dict:
        ...
        active_spells: list[SpellCard] = [
            ...
            card.name in self.known_spells
        ]
        ...
        if active_spells:
            ...
            targets: list = game_state[spell_to_cast.get_correct_targets()]
    ...
    def get_card_info(self) -> dict:
        ...
        } | self.get_combat_stats() | self.get_magic_stats()
